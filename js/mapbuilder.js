...
MapBuilder.prototype.createMap = function() {
  ...
  this.createGap(1);
  this.createSteppedWallSpan(1,10);
  this.createGap(1);
  this.createSteppedWallSpan(2,6);
  this.createGap(1);
  this.createSteppedWallSpan(1,8);
  this.createGap(1);
  this.createSteppedWallSpan(2,6);
  this.createGap(1);
  this.createSteppedWallSpan(1,8);
  ...
  this.createSteppedWallSpan(2,7);
  this.createGap(1);
  this.createSteppedWallSpan(1,16);
  this.createGap(1);
  this.createSteppedWallSpan(2,6);
  this.createGap(1);
  this.createSteppedWallSpan(1,22);
  this.createGap(2);
  this.createSteppedWallSpan(2,14);
  this.createGap(2);
  this.createSteppedWallSpan(3,8);
  this.createGap(2);
  this.createSteppedWallSpan(3,5,12);
  this.createGap(3);
  this.createSteppedWallSpan(0,8);
  this.createGap(3);
  this.createSteppedWallSpan(1,50);
  this.createGap(20);
